        ...
        if [] in clauses:
            ...
            for k, v in truth_values.items():
                if v is True:
                    print(k, v)
            print("unsat")
            print(f"amount of splits: {self.amount_of_splits}")
...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        count_amount_sudokus += 1
        if count_amount_sudokus == 500:
            print("500 sudokus solved")
            # break
    # print(sat.tru)
    # print("--- %s seconds ---" % runtime)
    ...
    df.head()
    directory = Path("C:/Users/Janus/Desktop/New folder/results")
    file_name = "results_4x4_"+str(heuristic)+".csv"
